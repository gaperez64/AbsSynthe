...
GNU_TIME=gtime
prog=$HOME/Dropbox/ULB"/AbsSynthe/abssynthe.py"
REAL=10
UNREAL=20
TIME_LIMIT=500
...
ulimit -t ${TIME_LIMIT}
export PYTHONPATH=$HOME/Dropbox/ULB"/AbsSynthe/pycudd2.0.2/pycudd":$PYTHONPATH
export LD_LIBRARY_PATH=$HOME/Dropbox/ULB"/AbsSynthe/pycudd2.0.2/cudd-2.4.2/lib":$LD_LIBRARY_PATH
export DYLD_LIBRARY_PATH=$HOME/Dropbox/ULB"/AbsSynthe/pycudd2.0.2/cudd-2.4.2/lib":$LD_LIBRARY_PATH
${GNU_TIME} -a -f "Synthesis time: %e sec (Real time) / %U sec (User CPU time)" python $prog $1 -v L
exit_code=$?
correct_real=$2
