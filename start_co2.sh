...
PYTHONPATH=$HOME"/AbsSynthe/pycudd2.0.2/pycudd":$PYTHONPATH LD_LIBRARY_PATH=$HOME"/AbsSynthe/pycudd2.0.2/cudd-2.4.2/lib":$LD_LIBRARY_PATH python $prog $1 -v L -d 1 -ca 2
exit_code=$?
correct_real=$2
